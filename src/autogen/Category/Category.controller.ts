...
export class CategoryController implements CrudController<Category> {
  ...
  @ApiOperation({ summary: 'Retrieve multiple Categorys' })
  ...
  @ApiOperation({ summary: 'Create a single Category' })
  @ApiBody({
    type: CategoryCreate,
    description:
  ...
  create(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Category) {
    return this.base.createOneBase(req, dto);
  }

  @Override('createManyBase')
  @ApiOperation({ summary: 'Create multipleCategorys' })
  createMany(
  ...
  @ApiOperation({ summary: 'Update a single Category' })
  update(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Category) {
    return this.base.updateOneBase(req, dto);
  }

  @Override('replaceOneBase')
  @ApiOperation({ summary: 'Replace a single Category' })
  replace(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Category) {
